...
def startexe(i):	
	...
	if(problems<3):
		...
		os.system("/na/share/ansa/meta_post_v14.2.5/meta_post64.sh -s ./metacompare.bs "+" -nogui "+firstfile+" "+firsttype+" "+secondfile+" "+secondtype+" "+outdir)	
		outlog=outdir+"/metacompare.log"
		os.system("rm -rf "+outlog)
		while(os.path.isfile(outlog)==0):
			time.sleep(1.0)
		if(os.path.isfile(outlog)==1):
